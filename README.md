...
**DentNav** — SDE Intern<br>
<sub>`JUN 2026 — PRESENT` · sole engineer</sub>
...
**Safe Odisha for Her** — Web Development Intern<br>
<sub>`DEC 2024 — AUG 2025` · NGO</sub>
...
**RAGnROLL** — document intelligence<br>
<sub>`SNOWFLAKE CORTEX · MISTRAL · STREAMLIT · TRULENS`</sub>
...
**TrinityTix** — distributed ticketing<br>
<sub>`FASTAPI · REDIS · SQLITE · MONGODB ATLAS`</sub>
...
**Flexcellent** — pose correction<br>
<sub>`FLUTTER · OPENCV · MEDIAPIPE · PYTEST`</sub>
...
**Game of Taash** — strategic multiplayer<br>
<sub>`C · RAYLIB · MONTE CARLO`</sub>
